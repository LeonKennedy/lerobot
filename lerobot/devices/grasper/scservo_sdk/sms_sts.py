...
class sms_sts(protocol_packet_handler):
    ...
    def ReadPosSpeed(self, scs_id):
        ...
        return self.scs_tohost(scs_present_position, 15), self.scs_tohost(scs_present_speed,
                                                                          15), scs_comm_result, scs_error
    ...
    def setTorqueLimit(self, scs_id: int, val: int):
        return self.write4ByteTxRx(scs_id, SMS_STS_TORQUE_LIMIT, val)
